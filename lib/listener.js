    ...
    return function(req, res)
        {
            ...
            req.on('end', function() {
                ...
                req.method === 'post'   && (req.post_args   = kiel.qs.parse(temp_chunk));
                req.method === 'put'    && (req.put_args    = kiel.qs.parse(temp_chunk));
                req.method === 'delete' && (req.delete_args = kiel.qs.parse(temp_chunk));
